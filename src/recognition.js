...
import {polygonBounds,validPolygon} from './geometry.js?v=82168a3e723a';
...
async function runDetection(data,options,{signal,timeoutMs=12000}={}){
 ...
 if(typeof Worker==='function'){
  try{return await new Promise((resolve,reject)=>{
   ...
   const abort=()=>finish(canceled());
   try{worker=new Worker(new URL('./recognition-worker.js?v=82168a3e723a',import.meta.url),{type:'module'});}catch(err){finish(Object.assign(Error('当前浏览器未启用识图线程。'),{code:'worker-unavailable'}));return;}
